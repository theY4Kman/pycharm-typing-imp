 ...
 *
 * One of these routes (and, preferably, the latter) would be required to cleanly implement the
 * GetattrTypeProvider without overriding typing info for non-dynamic attributes. Instead, we perform
...
internal fun getTypeByControlFlow(
    ...
    } catch (ignored: InstructionNotFoundException) {
    }
    return null
}
